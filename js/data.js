...
const COUNTRIES_DATA = {
  "الأردن": {
    ...
    regions: {
      "عمان":    ["الرئيسي","جسر البيبسي","ماركا الشمالية","الهاشمي","صويلح","الحرية","خلدا","نزال","الوحدات","مرج الحمام","وادي الرمم","المشاغل","طبربور","الرياضية","المنورة","ابو نصير","شارع المطار","الياسمين","الخريطة","اليادودة","طريق البحر الميت","الحجرة","شارع الاستقلال","دابوق"],
