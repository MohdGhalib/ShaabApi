...
══════════════════════════════════════════════════════ */
const REGION_MAP = {
    'الشرقية':    ['الرئيسي','جسر البيبسي','ماركا الشمالية','طبربور','الهاشمي','المشاغل','الرياضية','وادي الرمم','نزال','الوحدات'],
    'الجنوبية':   ['مرج الحمام','طريق البحر الميت','اليادودة','الحرية','الياسمين','الخريطة'],
    'الغربية':    ['السلط','صويلح','ابو نصير','المنورة','خلدا الراية','شارع الاستقلال','شارع المطار','المطار','مادبا الغربي','مادبا الشرقي','خلدا'],
    'المحافظات':  ['الطيارة','شارع ال30','ابو راشد','الرمثا','المفرق','جرش','شارع 36','السعادة','الكرك الوسية','الكرك الثنية'],
    'فروع العقبة':['الرئيسي العقبة','البيتزا','الثاني','الثالث','الرابع','الخامس','السادس','السابع','الثامن','التاسع','العاشر','الخلفي']
};
const REGION_STYLE = {
    ...
    'فروع العقبة':{ bar:'linear-gradient(90deg,#b71c1c,#ef5350)', header:'rgba(183,28,28,0.15)',  headerBorder:'rgba(183,28,28,0.35)',  headerColor:'#ef9a9a' }
};
