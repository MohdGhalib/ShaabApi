...
<div class="card" id="addInquiryCard">
    ...
    <div style="display:flex;gap:14px;align-items:flex-start;margin-top:5px;flex-wrap:wrap;">
        ...
        <div id="iBranchInfoPanel" style="flex:0 0 360px;display:none;max-width:100%;"></div>
        <div id="iBranchMontasiatPanel" style="flex:1 1 320px;display:none;min-width:260px;"></div>
    </div>
</div>
